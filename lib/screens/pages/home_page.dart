    ...
    return Scaffold(
      body: ListView.builder(
        ...
        return GestureDetector(
          onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context) => mlKits[index]['route']));
          },
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Expanded(child: Text(mlKits[index]['name'], style: const TextStyle(fontSize: 26),),),
                Expanded(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(15),
                      image: DecorationImage(image: AssetImage(mlKits[index]['img']), fit: BoxFit.cover)
                    ),
                  ),
                ),
              ],
